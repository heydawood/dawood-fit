        ...
        {Object.keys(WORKOUTS).map((type, typeIndex) => {
          ...
          return (
            ...
            <button
              ...
              className={'bg-slate-950 border-2 rounded-lg duration-200 hover:border-blue-800 py-3 px-4 ' + (type === poison ? 'border-blue-800' : 'border-blue-400')} key={typeIndex}>
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          ...
          return (
            ...
            <button onClick={() => {
              ...
              className={'bg-slate-950 border-2 rounded-lg duration-200 hover:border-blue-800 py-3 px-4 ' + (scheme === goal ? 'border-blue-800' : 'border-blue-400')} key={schemeIndex}>
